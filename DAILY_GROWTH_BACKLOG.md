...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | DRSA-001 | YELLOW | Add one contextual broader-routing link from SmallDogRescue.co.za's rescue directory | Exact source verified 2026-07-16: `/home/gareth/smalldogrescue/src/pages/find-a-small-dog-rescue.astro`, after the “How results are chosen” disclosure and before province routes. Proposed copy: “Dog not covered by these small-breed routes? Use [Dog Rescue SA's broader dog rescue pathway](https://dogrescuesa.co.za/) to find the most relevant next step. Dog Rescue SA is a signpost only; partner organisations make their own decisions and may not have capacity.” This serves non-small-breed users without duplicating specialist guidance or creating a footer link wheel. Target repository currently has unrelated modified `docs/audits/partner-url-check-latest.json`, so the release circuit breaker blocks editing. | High | High | Low | Low | Execute as a separate cross-repository change only when the target worktree is clean and source wording has not drifted |
| 2 | DRSA-002 | MONITOR | Confirm Google processes the seven-URL sitemap and inspect core URL coverage | Sitemap resubmitted 2026-07-16 with zero errors and pending processing. Homepage indexed; several subpages were only discovered or unknown at audit time. | High | High | Low | Low | Daily status; evaluate trend after 2026-07-23 and 2026-08-13 |
