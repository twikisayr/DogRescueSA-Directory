...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | DRSA-001 | YELLOW | Select one genuinely useful contextual inbound-link opportunity from an appropriate network guidance page | The 2026-07-16 sampled network crawl found no contextual inbound support. Must inspect the exact source page, confirm user benefit and avoid cross-site cannibalisation before proposing or editing. Cross-repository change remains proposal-only unless clearly scoped and safe. | High | Medium | Medium | Medium | Research now; one source-page proposal at a time |
